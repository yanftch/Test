...
//        setMeasuredDimension((int) (unitWidth * 6), getMeasuredHeight());
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            pointRadius = typedArray.getDimensionPixelSize(R.styleable.pwdNoView_pointRadius, Util.dpToPx(getContext(), 8));
            ...
            if (listener != null) {
                ...
                if (code.length() == length) {
                    if (!code.equals("111111")){
                        ...
                        code = "";
                        //吐司提示
                        Toast.makeText(mContext, "密码不对，炸了啊！", Toast.LENGTH_SHORT).show();
                    }else {
